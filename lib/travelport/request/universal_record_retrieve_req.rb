module Travelport::Request
  class UniversalRecordRetrieveReq < Base
    ...
    def request_body
      builder = Nokogiri::XML::Builder.new do |xml|
        xml.root do
          ...
          xml.UniversalRecordLocatorCode universal_record_locator_code
        end
      end
    ...
    def request_attributes
      super.except('Xmlns', 'UniversalRecordLocatorCode').update(xmlns: xmlns)
    end
  end
end
