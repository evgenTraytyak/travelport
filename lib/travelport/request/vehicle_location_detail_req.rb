module Travelport::Request
  class VehicleLocationDetailReq < Base
    ...
    def request_attributes
      super.except('Xmlns', 'PickupLocation', 'ReturnLocation', 'PickupDate', 'ReturnDate', 'VendorCode', 'VendorLocationId', 'ProviderCode').update(:xmlns => xmlns)
    end
  end
end
