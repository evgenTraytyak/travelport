      ...
      builder = Nokogiri::XML::Builder.new do |xml|
        xml.root {
          ...
          sectors.each do |sector|
            xml.SearchAirLeg {
              xml.SearchOrigin {
                xml.CityOrAirport('Code' => sector[:from], 'xmlns' => 'http://www.travelport.com/schema/common_v25_0')
              }
              xml.SearchDestination {
                xml.CityOrAirport('Code' => sector[:to], 'xmlns' => 'http://www.travelport.com/schema/common_v25_0')
              }
